...
Name: iptables-mod-pktsize
Version: 1.2.1
Release: 0%{?dist}
License: GPLv3
Group: System Environment/Base
Source: https://github.com/mimuret/iptables-mod-pktsize/iptables-mod-pktsize-%{version}.zip
URL: https://github.com/mimuret/iptables-mod-pktsize
...
/%{_lib}/xtables/libxt_pktsize.*
/lib/modules/%(uname -r)/%{_mod_dir}/xt_pktsize.ko
